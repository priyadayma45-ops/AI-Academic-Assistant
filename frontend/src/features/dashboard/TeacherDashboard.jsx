        ...
        <Card className="p-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900 dark:text-white">Welcome back, Professor {user?.name}!</h1>
        ...
        <Card>
          <CardBody>
            ...
            <div className="flex items-center gap-2 text-xs text-brand-500 font-semibold">
              ...
              Ready for Phase 5 & 6: Template Configurator & Teacher Panels
            </div>
          </CardBody>
        </Card>
      </div>
